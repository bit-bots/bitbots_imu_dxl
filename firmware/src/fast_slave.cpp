...
bool 
FastSlave::setPacketBuffer(uint8_t* p_buf, uint16_t buf_capacity)
{
  if(p_packet_buf_ == nullptr){
...
uint8_t* 
FastSlave::getPacketBuffer() const
{
  return p_packet_buf_;
}

uint16_t 
FastSlave::getPacketBufferCapacity() const
{
  return packet_buf_capacity_;
}

bool 
FastSlave::setPortProtocolVersion(float version)
{
  uint8_t version_idx;
...
bool 
FastSlave::setPortProtocolVersionUsingIndex(uint8_t version_idx)
{
...
float 
FastSlave::getPortProtocolVersion() const
{
  return (float)protocol_ver_idx_;
}

uint8_t 
FastSlave::getPortProtocolVersionIndex() const
{
  return protocol_ver_idx_;
}

uint16_t
FastSlave::getModelNumber() const
{
  return model_num_;
}

bool 
FastSlave::setID(uint8_t id)
{
...
uint8_t 
FastSlave::getID() const
{
  return id_;
}

void 
FastSlave::setFirmwareVersion(uint8_t version)
{
  firmware_ver_ = version;
}

uint8_t 
FastSlave::getFirmwareVersion() const
{
...
uint8_t FastSlave::getNumCanBeRegistered() const
{
  return CONTROL_ITEM_MAX-registered_item_cnt_;
}

bool FastSlave::isEnoughSpaceInControlTable(uint16_t start_addr, uint16_t length)
{
...
uint8_t FastSlave::addControlItem(uint16_t start_addr, uint8_t* p_data, uint16_t length)
{
...
uint8_t FastSlave::addControlItem(uint16_t start_addr, bool &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, uint8_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, uint16_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, uint32_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, uint64_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, int8_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, int16_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, int32_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, int64_t &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, float &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}

uint8_t FastSlave::addControlItem(uint16_t start_addr, double &data)
{
  return addControlItem(start_addr, (uint8_t*)&data, (uint16_t)sizeof(data));
}
...
void FastSlave::setWriteCallbackFunc(userCallbackFunc callback_func, void* callback_arg)
{
  user_write_callback_ = callback_func;
  user_write_callbakc_arg_ = callback_arg;
}

void FastSlave::setReadCallbackFunc(userCallbackFunc callback_func, void* callback_arg)
{
...
bool 
FastSlave::setPort(DXLPortHandler *p_port)
{
  return true;
  if(p_port == nullptr){
    last_lib_err_ = DXL_LIB_ERROR_NULLPTR;
...
bool 
FastSlave::setPort(DXLPortHandler &port)
{
  return true;
  p_port_ = &port;
...
DXLPortHandler* 
FastSlave::getPort() const
{
  return p_port_;
}

DXLLibErrorCode_t
FastSlave::getLastLibErrCode() const
{
  return last_lib_err_;
}

void
FastSlave::setLastLibErrCode(DXLLibErrorCode_t err_code)
{
  last_lib_err_ = err_code;
}

uint8_t 
FastSlave::getLastStatusPacketError() const
{
...
bool 
FastSlave::addDefaultControlItem()
{
...
bool 
FastSlave::processInst(uint8_t inst_idx)
{
  bool ret = false;
...
bool 
FastSlave::txStatusPacket(uint8_t id, uint8_t err_code, uint8_t *p_param, uint16_t param_len)
{
  bool ret = false;
  DXLLibErrorCode_t err = DXL_LIB_OK;
...
bool
FastSlave::rxInstPacket(uint8_t* p_param_buf, uint16_t param_buf_cap)
{
