...
#ifndef DYNAMIXEL_FAST_SLAVE_HPP_
#define DYNAMIXEL_FAST_SLAVE_HPP_
...
class FastSlave
{
  public:
    ...
    bool rxInstPacket(uint8_t* p_param_buf, uint16_t param_buf_cap);
...
#endif /* DYNAMIXEL_FAST_SLAVE_HPP_ */
